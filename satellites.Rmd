...
Predctive analysis 
 - The expected life time of a satellite is highly related ( 69 percent ) to its purpose and class of orbit
...
linregEL=lm(expected_lifetime ~ purpose + class_of_orbit ,
...
logG1 <- glm (Guiana ~ GEO + LEO + MEO + Commercial + Military + Civil + Communication +
                     EObs + TechDev + GPS + SpScience + TechDemo + Martime
             , data= satdata, family= binomial(logit))

summary(logG1)

linregG <- lm (Guiana ~ GEO + LEO + MEO + Commercial + Military + Civil + Communication +
                     EObs + TechDev + GPS + SpScience + TechDemo + Martime, data= satdata)
summary(linregG)

logG <- glm (Guiana ~ users + country_of_contractor, data= satdata, family= binomial())
summary(logG)

linregG1 <- lm (Guiana ~ GEO + MEO + Commercial + Military + GPS + country_of_contractor, data= satdata)
summary(linregG1)

#############################################################################
############################## Baikonur #####################################

linregB<- lm (Baikonur ~ GEO + LEO + MEO + Commercial + Military + Civil + Communication +
                     EObs + TechDev + GPS + SpScience + TechDemo + Martime, data= satdata)
summary(linregB)

linregB1 <- lm (Baikonur ~ Commercial + Military + country_of_contractor, data= satdata)
summary(linregB1)
...
linregC<- lm (Baikonur ~ GEO + LEO + MEO + Commercial + Military + Civil + Communication +
                     EObs + TechDev + GPS + SpScience + TechDemo + Martime, data= satdata)
summary(linregC)

linregC1 <- lm (Baikonur ~ Commercial + Military + country_of_contractor, data= satdata)
summary(linregC1)
